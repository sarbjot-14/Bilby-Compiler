...
public class NotEqualsCodeGeneratorInt implements SimpleCodeGenerator {
	...
	public NotEqualsCodeGeneratorInt(ASMOpcode subtractOpcode, ASMOpcode jumpPosOpcode, ASMOpcode jumpFalseOpcode, ASMOpcode duplicateOpcode) {
		super();
	...
	public ASMCodeFragment generate(ParseNode node, List<ASMCodeFragment> args) {
		...
		Labeller labeller = new Labeller("notEqualsInt");

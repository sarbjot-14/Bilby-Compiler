...
public class IntRightRangeAdditionCodeGenerator implements SimpleCodeGenerator {
	


	public IntRightRangeAdditionCodeGenerator() {
		super();
	...
	public ASMCodeFragment generate(ParseNode node, List<ASMCodeFragment> args) {
		...
		Labeller labeller = new Labeller("rangeAdditionRight");

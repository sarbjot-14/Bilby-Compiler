...
public class EqualsCodeGeneratorInt implements SimpleCodeGenerator {
	...
	public EqualsCodeGeneratorInt(ASMOpcode subtractOpcode, ASMOpcode jumpPosOpcode, ASMOpcode jumpFalseOpcode, ASMOpcode duplicateOpcode) {
		super();
	...
	public ASMCodeFragment generate(ParseNode node, List<ASMCodeFragment> args) {
		...
		Labeller labeller = new Labeller("equals-int");
